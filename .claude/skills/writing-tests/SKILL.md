...
| ----------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Counting invocations** — `vi.spyOn`, `toHaveBeenCalled`, `mock.calls.length`, counter variables, execution-order arrays (`applied.push(...)`)             | Asserting on "was this called" instead of "what did the user see"                                                                                               | Find the user-facing consequence (state change, return value, emitted event). If there isn't one, the behavior isn't worth a unit test                                  |
