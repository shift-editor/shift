...
export const GlyphGrid = () => {
  ...
  return (
    <section className="h-full w-full bg-[#3a3a3a]">
        ...
        {Object.values(ADOBE_LATIN_1).map((glyph) => {
          return (
            <div key={glyph.char_name}>
              <button
                className="border-secondary-200 h-ful flex aspect-square w-full items-center justify-center rounded-md bg-black/75 text-center text-[4rem] text-white/60 transition-colors duration-200 hover:bg-[#868686]"
