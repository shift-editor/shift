        ...
        {Object.values(ADOBE_LATIN_1).map((glyph) => {
          return (
            <div key={glyph.char_name}>
              <button
                className="border-secondary-200 h-ful flex aspect-square w-full items-center justify-center rounded-md bg-[#ededed] text-center text-[4rem] text-black/30 transition-colors duration-200 hover:bg-[#868686]"
