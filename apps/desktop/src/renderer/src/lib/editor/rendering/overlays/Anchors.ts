...
import type { GlyphRenderAnchor, GlyphRenderAnchorShape } from "@/types/glyphRender";
...
export class Anchors {
  ...
  drawShapes(canvas: Canvas, anchors: readonly GlyphRenderAnchorShape[]): void {
    for (const anchor of anchors) {
      drawHandle(canvas, anchor, "anchor", "idle");
    }
  }
