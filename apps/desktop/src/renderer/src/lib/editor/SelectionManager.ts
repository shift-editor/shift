...
export class SelectionManager {
  ...
  get selectedPointIds(): ReadonlySet<PointId> {
    return this.#selectedPointIds.value;
  }

  get selectedSegmentIds(): ReadonlySet<SegmentId> {
  ...
  get selectedPointIdsSignal(): WritableSignal<ReadonlySet<PointId>> {
    return this.#selectedPointIds;
  }

  get selectedSegmentIdsSignal(): WritableSignal<ReadonlySet<SegmentId>> {
    return this.#selectedSegmentIds;
  }

  get selectionModeSignal(): WritableSignal<SelectionMode> {
    return this.#selectionMode;
  }

  selectPoint(pointId: PointId): void {
  ...
  selectSegment(segmentId: SegmentId): void {
