...
import type { ToolEvent } from "@shift/editor/lib/tools/core/GestureDetector";
...
import { signal, type Signal } from "@shift/editor/lib/signals/index";
import type { CursorType } from "@shift/editor/types/editor";
