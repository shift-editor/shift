...
function colorThemeVariables(theme: ColorTheme): Record<string, string> {
  ...
  return {
    ...
    "--color-hover": palette.base02,
    "--color-surface-hover": dark ? palette.base02 : palette.base01,
    "--color-surface-inverse": palette.base07,
    "--color-on-surface-inverse": palette.base00,
    "--color-input": palette.base01,
    "--color-icon-button": palette.base01,
    "--color-icon-button-hover": palette.base02,
    "--color-line": dark ? palette.base03 : palette.base06,
    "--color-line-subtle": dark ? palette.base02 : palette.base01,
