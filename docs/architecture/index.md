...
| `apps/desktop/src/renderer/src/lib/model/**`     | [`apps/desktop/src/renderer/src/lib/model/docs/DOCS.md`](../../apps/desktop/src/renderer/src/lib/model/docs/DOCS.md)         | Reactive font, authored layers, projections, and glyph views       |
