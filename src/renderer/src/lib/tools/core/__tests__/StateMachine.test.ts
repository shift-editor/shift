...
describe('StateMachine', () => {
  ...
  describe('isIn', () => {
    ...
    it('should return true when in any of the specified states', () => {
      const sm = createStateMachine<TestState>({ type: 'loading', progress: 50 });
  ...
  describe('when', () => {
    it('should call handler when in the matching state', () => {
      const sm = createStateMachine<TestState>({ type: 'loading', progress: 75 });
      const handler = vi.fn();
    ...
    it('should provide typed state to handler', () => {
      const sm = createStateMachine<TestState>({ type: 'success', data: 'test data' });
  ...
  describe('match', () => {
    ...
    it('should work with partial handlers', () => {
      const sm = createStateMachine<TestState>({ type: 'success', data: 'hello' });
