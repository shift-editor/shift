...
crates/shift-workspace/src/
  ...
  source_identity.rs -- legacy package identity snapshots and source-save validation
...
- `shift-source` -- legacy `.shift` ZIP package compatibility.
