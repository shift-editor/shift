...
- **Scale-preserving preview extents.** Every authored root page reports maximum all-source horizontal overhang and vertical bounds. The Grid may enlarge shared cells from those extents, but Slug never fits individual glyphs by changing pixels per em.
